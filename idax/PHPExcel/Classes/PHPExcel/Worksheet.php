...
class PHPExcel_Worksheet implements PHPExcel_IComparable
{
     ...
     *
     * @var PHPExcel_Worksheet_HTMLHeaderFooter
     */
    private $htmlHeaderFooter;

    /**
     * Page PDF header/footer
     *
     * @var PHPExcel_Worksheet_PDFHeaderFooter
     */
    ...
    */
    ...
    public function __construct(PHPExcel $pParent = null, $pTitle = 'Worksheet')
    {
        ...
        // Set page HTML header/footer
        $this->htmlHeaderFooter       = new PHPExcel_Worksheet_HTMLHeaderFooter();
        // Set page HTML header/footer
        $this->pdfHeaderFooter        = new PHPExcel_Worksheet_PDFHeaderFooter();
        // Set sheet view
   ...
   /**
    ...
    /**
     * Get page HTML header/footer
     *
     * @return PHPExcel_Worksheet_HTMLHeaderFooter
     */
    public function getHTMLHeaderFooter()
    {
        return $this->htmlHeaderFooter;
    }
     ...
     * @return PHPExcel_Worksheet
     */
    public function setHTMLHeaderFooter(PHPExcel_Worksheet_HTMLHeaderFooter $pValue)
    {
        $this->htmlHeaderFooter = $pValue;
        return $this;
    }

    /**
     * Get page PDF header/footer
     *
     * @return PHPExcel_Worksheet_PDFHeaderFooter
     */
    public function getPDFHeaderFooter()
    {
        return $this->pdfHeaderFooter;
    }
     ...
     * @return PHPExcel_Worksheet
     */
    public function setPDFHeaderFooter(PHPExcel_Worksheet_PDFHeaderFooter $pValue)
    {
        $this->pdfHeaderFooter = $pValue;
        return $this;
    }
