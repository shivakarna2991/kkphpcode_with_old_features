...
if (!defined('PHPEXCEL_ROOT')) {
    define('PHPEXCEL_ROOT', "/home/idax/vendor/PHPExcel/Classes/");
}

if (!defined('IDAX_PHPEXCEL_ROOT')) {
    define('IDAX_PHPEXCEL_ROOT', dirname(__FILE__) . '/');
    require(IDAX_PHPEXCEL_ROOT . 'PHPExcel/Autoloader.php');
}
