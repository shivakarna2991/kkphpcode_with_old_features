      ...
      DBG_RETURN(DBGZ_TUBE_CLASSREPORT, __METHOD__);
			...
			)
		{
			DBG_ENTER(
					...
					__METHOD__,
					"jobId=$jobId, jobSiteId=$jobSiteId, ingestionId=$ingestionId, startTime=$startTime, endTime=$endTime, siteCode=$siteCode, primaryDirection=$primaryDirection, secondaryDirection=$secondaryDirection"
					);
