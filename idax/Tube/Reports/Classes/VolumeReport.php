<?php
	...
	class VolumeReport
	{
		...
		private $templateRangeMultiDayTitle = NULL;
		private $templateRangeMultiDayDaily = NULL;
		private $templateRangeMultiDayAve = NULL;
		private $templateRangeMultiDaySummary = NULL;
		private $templateRangeOneDayByHour = NULL;
		...
		private function InitializeBuckets()
		{
			...
			while ($time <= $endTime)
			{
				...
				if($time >= strtotime($this->studyStartTime) && $time <= strtotime($this->studyEndTime))
				{
		...
		//private $templateRangeMultiDaySummary = NULL;
            ...
            {
                case "standard":
                    $this->templateRangeMultiDayTitle = "E5:Z40";
                    $this->templateRangeMultiDayDaily = "F11:H39";
                    $this->templateRangeMultiDayAve = "AA5:AC39";
                    $this->templateRangeMultiDaySummary = "AE5:AK22";
                    break;
                case "bellevue":
                    $this->templateRangeMultiDayTitle = "E5:Z40";
                    $this->templateRangeMultiDayDaily = "F11:H39";
                    ...
                    break;
                case "redmond":
                    $this->templateRangeMultiDayTitle = "AN5:BI40";
                    $this->templateRangeMultiDayDaily = "AO11:AQ39";
                    $this->templateRangeMultiDayAve = "BJ5:BL39";
                    $this->templateRangeMultiDaySummary = "BN5:BT22";
                    break;
            }
			...
			ExcelHelpers::ReplicateRange($this->worksheetTemplates, $this->templateRangeMultiDayTitle, $this->multiDayHourlyWorksheet, "A1", TRUE);
            ...
            switch ($this->reportFormat)
            {
                ...
                case "bellevue":
                    ...
                    break;
                case "redmond":
                    $this->multiDayHourlyWorksheet->setCellValue("C1", $this->location);
                    $this->multiDayHourlyWorksheet->setCellValue("C2", $this->specificLocation);
                    $this->multiDayHourlyWorksheet->setCellValue("C3", "$this->siteCode");
                    $this->multiDayHourlyWorksheet->setCellValue("C4", "$this->stationId");
                    $this->multiDayHourlyWorksheet->setCellValue("C5", "$studyStartDate - $studyEndDate");
                    break;
            }
			...
			foreach ($this->hourlyBuckets as $key => &$hourlyBucket)
			{
				...
				{
					$dayColumn++;
					DBG_INFO(DBGZ_TUBE_VOLUMEREPORT, __METHOD__, "daycolumn=$dayColumn");

					ExcelHelpers::ReplicateRange($this->worksheetTemplates, $this->templateRangeMultiDayDaily, $this->multiDayHourlyWorksheet, "{$dayColumn}7", TRUE);
			...
			ExcelHelpers::ReplicateRange($this->worksheetTemplates, $this->templateRangeMultiDayAve, $this->multiDayHourlyWorksheet, "{$dayColumn}1", TRUE);
			...
			$this->multiDayHourlyWorksheet->mergeCells("A{$footNoteRow}:Y{$footNoteRow}");
			...
			ExcelHelpers::ReplicateRange($this->worksheetTemplates, $this->templateRangeMultiDaySummary, $this->multiDayHourlyWorksheet, "{$dayColumn}1", TRUE);
			...
			)
		{
            ...
            {
                case "standard":
                    $this->templateRangeOneDayByHour = "E45:H80";
                    
                    ExcelHelpers::ReplicateRange($this->worksheetTemplates, $this->templateRangeOneDayByHour, $this->oneDay1hourWorksheet, "A{$currentRow}", TRUE);
                ...
                case "bellevue":
                    ...
                    break;
                case "redmond":
                    $this->templateRangeOneDayByHour = "AN43:AQ80";
                    ...
                    $this->oneDay1hourWorksheet->setCellValue("B{$currentRow}", $this->specificLocation);
                    $currentRow++;

                    $this->oneDay1hourWorksheet->setCellValue("B{$currentRow}", $this->siteCode);
                    $currentRow++;
 
                    $this->oneDay1hourWorksheet->setCellValue("B{$currentRow}", $this->stationId);
                    $currentRow++;
			...
			)
		{
			DBG_ENTER(
					...
					__METHOD__,
					"jobSiteId=$jobSiteId, ingestionId=$ingestionId, reportFormat=$reportFormat, studyStartTime=$studyStartTime, studyEndTime=$studyEndTime, siteCode=SsiteCode, primaryDirection=$primaryDirection, secondaryDirection=$secondaryDirection"
					);
			...
			else
			{
				...
				else
				{
                   ...
                   //get coresponded office contact information for this job
					...
					$replacements = array(_IDAX_REPORTS_PATH, "Class", "$primaryDirection / $secondaryDirection", $location, $siteCode, $studyStartDate, $studyEndDate, $this->stationId, $this->specificLocation, $officeEmail);
                    ...
                    switch ($this->reportFormat)
                    {
                        ...
                        case "redmond":
                            ...
                            $html = str_replace(
                                    $searchStrings,
                                    $replacements,
                                    file_get_contents(_IDAX_REPORTS_PATH."/templates/html/pdf_volume_page_header_redmond.html")
                                    );
					...
					$pageSetup->setPrintArea('A7:'.$maxColumn.$maxRow);
