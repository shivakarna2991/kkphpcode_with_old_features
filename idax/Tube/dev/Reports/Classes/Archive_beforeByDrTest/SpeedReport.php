	...
	class SpeedReport
	{
			...
			)
		{
			DBG_ENTER(
					...
					__METHOD__,
					"jobId=$jobId, jobSiteId=$jobSiteId, ingestionId=$ingestionId, filterBeginTime=$filterBeginTime, filterEndTime=$filterEndTime startTime=$startTime, endTime=$endTime, siteCode=SsiteCode, primaryDirection=$primaryDirection, secondaryDirection=$secondaryDirection"
					);
